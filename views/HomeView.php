...
(function($vm, $child, $template) {
    ...
    $view->content = function ($view) {
        ?>
        <vueper-slides :visible-slides="5" :touchable="false"
                       class="no-shadow">
            <vueper-slide v-for="(slide, i) in slides" 
                          :key="i" :title="slide.title" 
                          :content="slide.content" link="/" :image="slide.image"/>
        </vueper-slides>
    ...
    $view->render();
})($vm, null, "views/templates/MainTemplate.php");
?>
